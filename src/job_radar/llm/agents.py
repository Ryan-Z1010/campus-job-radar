...
MATCH_PROMPT_VERSION = "semantic-matching-v1"
...
你没有工具权限。只依据岗位证据和 sanitized_profile 判断匹配度。target_roles 和 preference_keywords 是求职偏好，\
不能当作候选人已掌握技能；只有 skills、experience_highlights、project_highlights 和 language_qualifications 才能作为能力证据。\
