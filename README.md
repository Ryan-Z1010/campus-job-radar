...
- 十类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API、智联校园公开公司页、北森门户公告追踪、才聚羊城企业岗位；
...
默认配置保留了首批目标官网。南方电网、南航和中国联通广东省分公司岗位
适配器，广州数字科技集团公开企业岗位监控，中国移动、中国电信、广州地铁和广汽集团 2027 校招启动监控，
以及小鹏集团 2027 届探索者计划提醒已经启用。其他动态站点在专用适配器
完成前保持关闭。可以先运行审计：
