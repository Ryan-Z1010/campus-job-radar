...
- 十七类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API、智联校园公开公司页、北森门户公告追踪、北森旧版校园岗位、猎聘静态校园岗位、才聚羊城企业岗位、广东国企招聘岗位、国聘企业岗位、公开高校招聘公告、Hotjob 公开校招岗位、广州工控官网岗位；
...
以及文远知行 2027 届秋招、小鹏集团 2027 届探索者计划提醒和小马智行
2027 届校招启动监控已经启用。
