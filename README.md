...
- 七类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API；
...
默认配置保留了首批目标官网。南方电网与南航岗位适配器、中国移动、中国
电信和广汽集团 2027 校招启动监控、小鹏集团 2027 届探索者计划提醒已经
启用。其他动态站点在专用适配器完成前保持关闭。可以先运行审计：
