...
- 十二类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API、智联校园公开公司页、北森门户公告追踪、才聚羊城企业岗位、公开高校招聘公告、Hotjob 公开校招岗位；
...
广州数字科技集团和越秀集团岗位适配器，中国移动、中国电信、广州地铁、
广州港和广汽集团 2027 校招启动监控，以及小鹏集团 2027 届探索者计划提醒
已经启用。
