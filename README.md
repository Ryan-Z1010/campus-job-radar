...
- 十三类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API、智联校园公开公司页、北森门户公告追踪、才聚羊城企业岗位、公开高校招聘公告、Hotjob 公开校招岗位、广州工控官网岗位；
...
广州数字科技集团、越秀集团和广州工控集团岗位适配器，中国移动、中国电信、
