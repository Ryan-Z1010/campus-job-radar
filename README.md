...
- 八类采集器：本地 JSON、公开 JSON API、公开公告 JSON、普通 HTML 链接、固定招聘公告、届别启动监控、南方电网公开匿名 API、智联校园公开公司页；
...
适配器，中国移动、中国电信和广汽集团 2027 校招启动监控，以及小鹏集团
2027 届探索者计划提醒已经启用。其他动态站点在专用适配器完成前保持
关闭。可以先运行审计：
